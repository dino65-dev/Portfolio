      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6" style={{ color: 'var(--text-primary)' }}>
              Thoughts &{' '}
              <span className="gradient-text">Insights</span>
            </h2>
            <p className="text-sm sm:text-base lg:text-lg max-w-2xl mx-auto mb-10 px-4" style={{ color: 'var(--text-muted)' }}>
            ...
            >
              <div
                className="spotlight-card animated-border relative rounded-2xl overflow-hidden p-6 sm:p-8 text-left group border border-[var(--border-warm)] dark:border-white/5 hover-lift"
                style={{ borderRadius: '1rem', backgroundColor: 'var(--card-bg)' }}
              ...
              >
                <div className="relative z-10">
                  ...
                  <p className="mb-4 text-sm sm:text-base" style={{ color: 'var(--text-muted)' }}>
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          {/* Live indicator */}
          <motion.div
            className="flex items-center justify-center gap-3 mt-4 text-xs sm:text-sm"
        ...
        {posts.length > 0 && (
          ...
          >
            ...
            >
              <div
                className="spotlight-card animated-border relative rounded-3xl overflow-hidden border border-[var(--border-warm)] dark:border-white/5 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-[#8B5CF6]/10"
              ...
              >
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className="relative h-48 sm:h-64 lg:h-auto lg:min-h-[320px] overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-l from-black/40 via-black/10 to-transparent" />
                  </div>
                  ...
                  <div className="relative p-6 sm:p-8 lg:p-12 flex flex-col justify-center z-10">
                    <div className="flex items-center gap-2 sm:gap-3 mb-4 flex-wrap">
                      ...
                      <span className="px-3 py-1 text-xs font-semibold bg-[#8B5CF6]/10 dark:bg-white/10 backdrop-blur-sm rounded-full flex items-center gap-1 border border-[#8B5CF6]/20 dark:border-white/5" style={{ color: 'var(--text-muted)' }}>
                        <Sparkles className="w-3 h-3" />
                        Latest
                      </span>
                    </div>

                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 group-hover:text-[#D946EF] transition-colors line-clamp-2 neon-text-hover" style={{ color: 'var(--text-primary)' }}>
                      {posts[0].title}
                    </h3>

                    <p className="leading-relaxed mb-6 line-clamp-2 sm:line-clamp-3 text-sm sm:text-base" style={{ color: 'var(--text-muted)' }}>
                      {posts[0].description}
                    </p>
                    ...
                    <span className="inline-flex items-center gap-2 font-semibold text-sm group/link" style={{ color: 'var(--text-primary)' }}>
                      Read on Medium
        ...
        {posts.length > 1 && (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {posts.slice(1).map((post, index) => (
              <motion.article
                key={post.id}
                className="spotlight-card animated-border group relative bg-[var(--card-bg-muted)] dark:bg-[var(--card-bg)] overflow-hidden border border-[var(--border-warm)] dark:border-white/5 transition-all duration-500 hover-lift"
              ...
              >
                ...
                >
                  ...
                  <div className="p-5 sm:p-6 relative z-10">
                    ...
                    <h3 className="text-base sm:text-lg font-bold mb-3 group-hover:text-[#8B5CF6] transition-colors line-clamp-2 neon-text-hover" style={{ color: 'var(--text-primary)' }}>
                      {post.title}
                    </h3>

                    <p className="text-xs sm:text-sm leading-relaxed mb-4 line-clamp-2" style={{ color: 'var(--text-muted)' }}>
                      {post.description}
                    </p>
        ...
        >
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="animated-border w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--card-bg-muted)] dark:bg-[var(--card-bg)] font-semibold border border-[var(--border-warm)] dark:border-white/10 hover:text-[#8B5CF6] transition-all text-sm touch-manipulation"
            style={{ borderRadius: '1rem', color: 'var(--text-primary)' }}
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            Visit Blog Site
