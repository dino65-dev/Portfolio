    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1A1F2C] dark:text-white">
            {aboutTitle}
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            ...
            <div
              className="spotlight-card p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5 mb-6"
            ...
            >
              {bio.split('\n\n').map((paragraph, index) => (
                <motion.p
                  key={index}
                  className="text-sm sm:text-base text-[#8E9196] leading-relaxed mb-4 last:mb-0 relative z-10"
            ...
            {education && (
              <motion.div
                className="spotlight-card animated-border group p-5 sm:p-6 bg-white dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5 transition-all duration-300 mb-6"
              ...
              >
                <div className="flex items-start gap-4 relative z-10">
                  ...
                  <div>
                    <h3 className="text-base sm:text-lg font-bold text-[#1A1F2C] dark:text-white mb-1">
                      Education
                    </h3>
                    <p className="text-sm text-[#8E9196]">{education}</p>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {interests.length > 0 && (
              <motion.div
                className="spotlight-card p-5 sm:p-6 bg-white dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5"
                style={{ borderRadius: '1rem' }}
                initial={{ opacity: 0, y: 20 }}
                animate={isInView ? { opacity: 1, y: 0 } : {}}
              ...
              >
                <div className="flex items-center gap-2 mb-4 relative z-10">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-[#1A1F2C] dark:text-white">
                    Interests
                  </h3>
                </div>
                <div className="flex flex-wrap gap-2 relative z-10">
                  {interests.map((interest, index) => (
                    <motion.span
                      key={interest}
                      className="skill-chip px-4 py-2 text-xs sm:text-sm font-medium text-[#1A1F2C] dark:text-white bg-[#F5F5F3] dark:bg-white/5 rounded-full border border-[#E8E8E6]/50 dark:border-white/5 cursor-default"
          ...
          {skills.length > 0 && (
            ...
            >
              <div className="sticky top-24">
                <div
                  className="spotlight-card animated-border-always animated-border p-6 sm:p-8 bg-white dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5 overflow-hidden relative"
                  style={{ borderRadius: '1.5rem' }}
                  onMouseMove={handleSpotlight}
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-2 mb-6">
                      ...
                      <h3 className="text-lg sm:text-xl font-bold text-[#1A1F2C] dark:text-white">
                        Skills & Tech
                      </h3>
                    </div>
                      ...
                      {skills.map((skill, index) => (
                        ...
                        >
                          <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#8B5CF6]/5 dark:hover:bg-[#8B5CF6]/10 transition-all duration-200 cursor-default group-hover/skill:translate-x-1">
                            ...
                            <span className="text-sm font-medium text-[#1A1F2C] dark:text-white group-hover/skill:text-[#8B5CF6] transition-colors">
                              {skill}
                            </span>
                    ...
                    {/* Skill count badge */}
                    <div className="mt-6 pt-6 border-t border-[#E8E8E6]/50 dark:border-white/5">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-[#8E9196]">Total Technologies</span>
