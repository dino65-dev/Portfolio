      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-sm sm:text-base lg:text-lg max-w-2xl" style={{ color: 'var(--text-muted)' }}>
  ...
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {featuredProjects.length > 0 && (
          <div className="space-y-8 sm:space-y-12 mb-16 sm:mb-20">
            {featuredProjects.map((project, index) => (
              <motion.article
                key={project.id}
                className="spotlight-card animated-border group relative rounded-3xl overflow-hidden bg-[var(--card-bg-muted)] dark:bg-[var(--card-bg)] border border-[var(--border-warm)] dark:border-white/5 transition-all duration-500 shadow-sm hover:shadow-2xl hover:shadow-[#8B5CF6]/10"
              ...
              >
                <div className={`grid lg:grid-cols-2 gap-0 ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}>
                  ...
                  <div className={`p-6 sm:p-8 lg:p-12 flex flex-col justify-center relative z-10 ${index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4 group-hover:text-[#8B5CF6] transition-colors duration-300 neon-text-hover" style={{ color: 'var(--text-primary)' }}>
                      {project.title}
                    </h3>
                    ...
                    <div className="flex flex-wrap gap-4">
                      {project.githubUrl && (
                        <motion.a
                          ...
                          className="neon-btn inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold bg-[var(--card-bg-muted)] dark:bg-white/5 rounded-xl hover:bg-[#8B5CF6] hover:text-white transition-all duration-300 group/btn touch-manipulation"
        ...
        {otherProjects.length > 0 && (
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold mb-8 flex items-center gap-2" style={{ color: 'var(--text-primary)' }}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {otherProjects.map((project, index) => (
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="spotlight-card animated-border tilt-3d group relative p-5 sm:p-6 border border-[var(--border-warm)] dark:border-white/5 bg-[var(--card-bg-muted)] dark:bg-[var(--card-bg)] transition-all duration-300 touch-manipulation overflow-hidden"
                ...
                >
                  <div className="relative z-10 tilt-content">
                    ...
                    <h4 className="text-base sm:text-lg font-bold mb-2 group-hover:text-[#8B5CF6] transition-colors neon-text-hover" style={{ color: 'var(--text-primary)' }}>
                      {project.title}
                    </h4>
