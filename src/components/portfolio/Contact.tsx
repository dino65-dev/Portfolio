        ...
        <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            <div className="space-y-4">
              {email && (
                <div
                  className="spotlight-card group p-5 bg-[#FAFAF8] dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5 transition-all"
                ...
                >
                  <div className="flex items-start gap-4 relative z-10">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-xs font-semibold text-[#8E9196] uppercase tracking-wider mb-1">
                        Email
                      </h3>
                      <a
                        href={`mailto:${email}`}
                        className="text-sm sm:text-base font-medium text-[#1A1F2C] dark:text-white hover:text-[#8B5CF6] transition-colors break-all neon-text-hover"
                      >
                        {email}
                      </a>
                    </div>
                ...
                >
                  <div className="flex items-start gap-4 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="text-sm sm:text-base font-medium text-[#1A1F2C] dark:text-white">
                        {location}
                      </p>
                    </div>
                  </div>
            ...
            {socialLinks.length > 0 && (
              <div className="mt-8">
                <h3 className="text-xs font-semibold text-[#8E9196] uppercase tracking-wider mb-4">
                  Connect with me
                </h3>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden animated-border" style={{ borderRadius: '1.5rem' }}>
                <img
          ...
          >
            <div
              className="spotlight-card animated-border p-6 sm:p-8 bg-white dark:bg-[#111118] border border-[#E8E8E6]/50 dark:border-white/5 shadow-sm"
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div className="floating-input-group">
                    <label
                      htmlFor="name"
                      className="block text-sm font-semibold text-[#1A1F2C] dark:text-white mb-2"
                    >
                      Name
                    </label>
                    <div className="relative">
                      <input
                        ...
                        className={`w-full px-4 py-3 bg-[#FAFAF8] dark:bg-white/5 border rounded-xl text-[#1A1F2C] dark:text-white placeholder-[#8E9196]/50 focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]/30 focus:border-[#8B5CF6] transition-all text-sm ${
                          errors.name
                            ? 'border-red-400'
                            : 'border-[#E8E8E6]/50 dark:border-white/5'
                        }`}
                ...
                <div className="floating-input-group">
                  <label
                    ...
                    className="block text-sm font-semibold text-[#1A1F2C] dark:text-white mb-2"
                  >
                    Subject <span className="text-[#8E9196] font-normal">(optional)</span>
                  </label>
                  <div className="relative">
                    <input
                      type="text"
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-[#FAFAF8] dark:bg-white/5 border border-[#E8E8E6]/50 dark:border-white/5 rounded-xl text-[#1A1F2C] dark:text-white placeholder-[#8E9196]/50 focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]/30 focus:border-[#8B5CF6] transition-all text-sm"
                ...
                <div className="floating-input-group">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={5}
                      className={`w-full px-4 py-3 bg-[#FAFAF8] dark:bg-white/5 border rounded-xl text-[#1A1F2C] dark:text-white placeholder-[#8E9196]/50 focus:outline-none focus:ring-2 focus:ring-[#8B5CF6]/30 focus:border-[#8B5CF6] transition-all resize-none text-sm ${
                        errors.message
                          ? 'border-red-400'
                          : 'border-[#E8E8E6]/50 dark:border-white/5'
                      }`}
