...
export function ThemeToggle() {
  ...
  return (
    <motion.button
      ...
      className="relative p-2.5 rounded-xl bg-white dark:bg-[#2A2F3C] border border-[#E8E8E6] dark:border-[#3A3F4C] text-[#1A1F2C] dark:text-white hover:border-[#8B5CF6] dark:hover:border-[#8B5CF6] transition-all duration-300 shadow-sm hover:shadow-md"
